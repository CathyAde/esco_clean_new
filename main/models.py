...
#     def __str__(self):
#         return f"RDV {self.patient.username} - Dr. {self.medecin.username} - {self.date_rdv.strftime('%d/%m/%Y %H:%M')}"
...
#     def __str__(self):
#         return f"Planning {self.user.username} - {self.date} {self.heure_debut}-{self.heure_fin}"
...
#     def __str__(self):
#         return f"Prescription {self.medicament} - {self.consultation.rdv.patient.username}"
